...
const testimonials = [
  {
    ...
    content:
      "Juno has been a game-changer for my mental health journey. The AI prompts help me explore thoughts I never knew I had, and the mood tracking shows me patterns I was missing. It's like having a therapist in my pocket.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Student",
    content:
      "I was struggling with anxiety and couldn't find the right words to express myself. Juno's gentle prompts and supportive approach made journaling feel less intimidating. Now I look forward to my daily reflection time.",
    categories: [1, 2, 4],
  },
  {
    ...
    content:
      "After a stressful day at work, Juno helps me unwind and process my thoughts. The AI understands my emotions and asks the right questions to help me gain clarity. It's become my daily mental health ritual.",
    categories: [1, 2, 5],
  },
  {
  ...
  },
  {
    ...
    name: "Michael R.",
    company: "Recovery Coach",
    content:
      "Juno has been instrumental in my recovery journey. The private, secure environment lets me be completely honest with myself, and the AI helps me process difficult emotions without judgment.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Parent",
    content:
      "Being a parent is overwhelming, and Juno helps me process my feelings about motherhood. The gentle reminders keep me consistent, and I love how it adapts to my emotional state each day.",
    categories: [1, 3],
  },
  {
    ...
    company: "Veteran",
    content:
      "Coming home from service, I struggled with PTSD and couldn't talk to anyone. Juno gave me a safe space to process my experiences. The AI prompts help me explore feelings I didn't know how to express.",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "Artist",
    content:
      "Creative blocks are real, and Juno helps me work through them. The mood tracking shows me when I'm most inspired, and the AI prompts spark new ideas. It's like having a creative partner who understands my mind.",
    categories: [1, 4],
  },
  {
    ...
    content:
      "Running a business is stressful, and Juno helps me manage my mental health. The insights help me recognize burnout before it happens, and the journaling gives me clarity on tough decisions.",
    categories: [1, 2],
  },
];
      ...
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          <p className="text-lg text-indigo-200/65">
            Join thousands of people who have found clarity, peace, and self-understanding through journaling with Juno.
          </p>
        </div>
